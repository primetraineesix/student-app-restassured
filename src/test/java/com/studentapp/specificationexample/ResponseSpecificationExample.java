...
public class ResponseSpecificationExample {
    ...
    public static void inIt(){
        ...
        responseBuilder.expectResponseTime(lessThan(5000L), TimeUnit.MILLISECONDS);
        responseBuilder.expectStatusLine("HTTP/1.1 200 OK");
        responseBuilder.expectHeader("Content-Type",equalTo("application/json; charset=utf-8"));
